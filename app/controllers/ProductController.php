...
class ProductController {
    ...
    public function read($id) {
        ...
        if ($product) {
            ...
            // Cargar una vista para mostrar los datos del producto
        } else {
            echo 'Error leyendo el registro.';
